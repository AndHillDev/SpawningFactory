...
public class ItemBlockLimeStoneBricksSlab extends ItemBlock {

	private final BlockSlab singleSlab;
    private final BlockSlab doubleSlab;
	
	public ItemBlockLimeStoneBricksSlab(Block block, BlockLimeStoneBricksHalfSlab singleSlab, BlockLimeStoneBricksDoubleSlab doubleSlab) {
		super(block);
